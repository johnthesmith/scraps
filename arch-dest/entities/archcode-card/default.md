...
Документ с описанием [entity](/entities/entity/lang=ru&gram-case=gen.md "") для
[EPL](/entities/epl/default.md "")-моделей. Строится из онтологические сущности на основе шаблона в
структурированные карточки документации фомата [md](/entities/md/default.md "").


---

Карточка любой [Сущность](/entities/entity/default.md "") генерируется из шаблона, указанного в самой сущности и 
ее свойств. 
...
1. Шаблон формируется из [md](/entities/md/default.md "") документа, который может включать подмены в
следующем формате:
...
```
    1. где:
        ...
        path - опциональный путь к своству [Сущность](/entities/entity/default.md "")
