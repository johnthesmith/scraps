...
загружаемый в репозитории [git](/arch-dest/entities/git/default.md ""), [wiki](/arch-dest/entities/wiki/default.md ""), либо web ресурс.



## Информация

1. [Вступление в archcode](/arch-dest/entities/archcode-intro/default.md "Документ с описанием archchcode")
