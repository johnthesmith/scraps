...
Документ с описанием [entity](/card/entity/lang=ru&gram-case=gen.md "") для
-моделей. Строится из онтологические сущности на основе шаблона в
структурированные карточки документации фомата .


---

Карточка любой  генерируется из шаблона, указанного в самой сущности и 
ее свойств. 
...
1. Шаблон формируется из  документа, который может включать подмены в
следующем формате:
...
```
    1. где:
        ...
        path - опциональный путь к своству 
