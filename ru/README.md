...
1. [automnemomorph](automnemomorph.md)
0. [Предложение по именованиею файловой структуры AI приложений](proposal_ai_config_standard.md)
0. [Принципиальная детерминированность нейросетей и безопасность](nn-determinism.md)
0. [Верификация нейросети как условие безопасной эксплуатации](nn-check.md)
0. [Pusa - WEB без JS на клиенте](pusa.md)
