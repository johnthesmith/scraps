...
1. Cозданное двумерное пространство точками p0 p2 p3, можно так же интерпритировать как замкнутое одномерное пространство.
2. В случае с тремя точками это не столь очевидно, для большего количества точек это можно проиллюстировать следующим образом:
