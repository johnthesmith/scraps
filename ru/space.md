...
> :information_source: Не следует пытаться трактовать все последующие рисуноки как координатные пространства в которых размещены объекты. Рисунки - лишь попытка иллюстрации.
