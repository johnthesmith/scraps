...
(LLM, сверточная и др.), при фиксированных аргументах `[a]`, фиксированных весах 
`[w]` и идентичных условиях исполнения, результат `r` детерминирован; любая 
вариация результата без изменения `[a]`, `[w]` или условий исполнения является 
ошибкой реализации.
...
Недетерминизм - это баг в вашем пайплайне, найдите его!
