...
недетерминированность исключена, наличие различных результатов про одних и тех 
же входных данных говорит об аппаратных ошибках и исключает валидный результат.
...
нейросети свидетельствует об отсутствии информации о происходящем в сети, либо о 
сокрытых ошибках на аппаратном, программном или алгоритмическом уровнях.
...
Обсуждение безопасности развития нейросетей в частности и AI в целом, 
должно быть основано на достижении гарантируемой повторяемости и проверяемости 
результатов.

Недетерминизм - баг в пайплайне, а не фича. Его необходимо устранить. При всем 
многообразии участников, самую серьезную часть рынка возмет тот, кто сумеет 
сделать это, показать и доказать полную подконтрольность (детерминированность) 
своего AI.
