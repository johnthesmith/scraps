...
Да, человек может ошибаться. Однако люди дожило до текущего момента, опираясь 
именно свой опыт — следовательно, он эволюционно оправдан.
...
одинаково ошибаться в точках, не виденных ни одной из них при обучении. А где 
...
3. Проверка одной нейросети другой — создание иллюзии контроля вместо реальной 
верификации, и несет риски.

---

PS: я признаю, что проверка одной нейросети другой нейросетью, это компромис 
развития, однако утверждаю, что на большом отрезке времени данная практика 
приведет либо к медленной деградации либо к внезапной катострофе эксплуатируемой 
системы.
