...
0. Предлагаемый ниже способ хранения информации позволяет создать универсальное 
описание и хранилище сущностей.
...
1. Реализцаяи предполагает следующие методы:
    ...
    0. [id2rid](#id2rid)
    0. [rid2id](#rid2id) - удаление сущности.
...
1. Метод id2rid возвращает id по rid при наличии такового.



## kill

1. Метод kill пытается выпольнить логическое удаление сущность по идетификатору.
...
``` 
bool kill( string id, array string dum[] )
```
