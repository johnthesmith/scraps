...
```
{
    "entities":
    [
        { "id":"entity",    "typeId":"entity" },
        { "id":"animal",    "typeId":"entity" },
        { "id":"human",     "typeId":"animal" },
        { "id":"cat",       "typeId":"animal" },
        { "id":"link",      "typeId":"entity" },
        { "id":"pet",       "typeId":"link" },
        { "id":"host",      "typeId":"link" },
        { "id":"lang",      "typeId":"entity" },
        { "id":"ru",        "typeId":"lang" },
        { "id":"en",        "typeId":"lang" }
    ],
    "links":
...
3. Дополнительно необходимы отношения:
    1. [properties](#properties) - контекстозависимые свойства сущностей;
    0. [links](#links) - связи сущностей.
