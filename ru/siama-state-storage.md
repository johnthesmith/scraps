...
#  Изменение состояний DB при обработке
...
## Паралельная обработка топка разными продюсерами

1. Решает задачу паральельной обработки без необходимости синхронизации
