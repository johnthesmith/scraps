...
1. Допускаются следующие схемы:
    1. [Линейная обработка](#линейная-обработка)
    0. [Паралельная обработка несинхронизированая обработке](#паралельная-обработка-несинхронизированая-обработке)
    0. [Объединение событий](объединение-событий)
...
## Паралельная обработка несинхронизированая обработке
