...
0. При взаимодейсвтии компонентов используюется следюущие обозначения:
    0. * - множество указанных компонентов (более одного);
...
1. Указанные компоненты классифицированы как:
    1. [Удовлетворительное взаимодействиеы](#удовлетворительное-взаимодействиеы)
    0. [Неудовлетворительное взаимодействиеы](#неудовлетворительное-взаимодействиеы)
