...
1. Перечислены взаимодействия, рекомендуемые к использованию в МСА в проихзвольной комбинации.
...
1. Предлагаются следующие примеры решений:
    ...
    0. [Обработка события](#)
    0. [Обработка событий из двух источников](#)
    0. [Гарантированная последовательная обработка](#)
    0. [Паралельная обработка события](#)
    0. [Паралельная обработка с общим результатом](#)
